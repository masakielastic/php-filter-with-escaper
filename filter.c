...
static const filter_list_entry filter_list[] = {
  ...
  { "validate_string_length", FILTER_VALIDATE_STRING_LENGTH,    php_filter_validate_string_length },
  ...
  { "escape_url", FILTER_ESCAPE_URL, php_escape_url },

  { "escape_ill_formed_bytes",  FILTER_ESCAPE_ILL_FORMED_BYTES, php_escape_ill_formed_bytes },
...
PHP_MINIT_FUNCTION(filter)
{
  ...
  REGISTER_LONG_CONSTANT("FILTER_VALIDATE_STRING_LENGTH", FILTER_VALIDATE_STRING_LENGTH, CONST_CS | CONST_PERSISTENT);
  ...
  REGISTER_LONG_CONSTANT("FILTER_ESCAPE_URL", FILTER_ESCAPE_URL, CONST_CS | CONST_PERSISTENT);

  REGISTER_LONG_CONSTANT("FILTER_ESCAPE_ILL_FORMED_BYTES", FILTER_ESCAPE_ILL_FORMED_BYTES, CONST_CS | CONST_PERSISTENT);
